                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { host-path , vacuum-path , ... } : "if [ -e ${ host-path } ] ; then ${ _environment-variable "CP" } --recursive ${ host-path } ${ vacuum-path } ; fi" ) secondary.mounts ) )
