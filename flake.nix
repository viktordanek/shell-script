                                                                                                                                        ...
                                                                                                                                        [
                                                                                                                                            ...
                                                                                                                                            (
                                                                                                                                                let
                                                                                                                                                    ...
                                                                                                                                                    in
                                                                                                                                                        "if ${ user-environment }/bin/observe > ${ _environment-variable "OUT" }/observed/standard-output 2> ${ _environment-variable "OUT" }/observed/standard-error ; then ${ _environment-variable "ECHO" } 99-${ _environment-variable "?" } > ${ _environment-variable "OUT" }/observed/status ; else ${ _environment-variable "ECHO" } 88-${ _environment-variable "?" } > ${ _environment-variable "OUT" }/observed/status ; fi"
                                                                                                                                            )
                                                                                                                                        ]
