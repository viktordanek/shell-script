                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                                                            ...
                                                                                                                                                                            [
                                                                                                                                                                                ...
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                                                                        mapper =
                                                                                                                                                                                            name : { ... } :
                                                                                                                                                                                                ''if [ $( ${ _environment-variable "CAT" } /out/initial/${ builtins.hashString "sha512" name }.status ) != 0 ] ; then ${ _environment-variable "ECHO" } error status with ${ name } >> $out/ERROR ; elif [ ! -z "$( ${ _environment-variable "CAT" } /out/initial/${ builtins.hashString "sha512" name }.standard-error )" ] ; then ${ _environment-variable "ECHO" } error output with ${ name } >> /out/ERROR ; elif [ ! -e /out/mounts/${ builtins.hashString "sha512" name }/target ] ; then ${ _environment-variable "ECHO" } missing target in ${ name } >&2 && exit 61 ; elif [ $( ${ _environment-variable "FIND" } /out/mounts/${ builtins.hashString "sha512" name } -mindepth 1 -maxdepth 1 | ${ _environment-variable "WC" } --lines ) != 1 ] ; then ${ _environment-variable "ECHO" } wrong in ${ name } >&2 && exit 57 ; fi'' ;
                                                                                                                                                                                        in builtins.attrValues ( builtins.mapAttrs mapper secondary.mounts )
                                                                                                                                                                                )
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                        ...
                                                                                                                                        (
                                                                                                                                            let
                                                                                                                                                mapper = name : { ... } : "INPUT=${ _environment-variable "OUT" }/mounts/${ builtins.hashString "sha512" name }/target OUTPUT=${ _environment-variable "OUT" }/observed ${ vacuum.shell-script }" ;
                                                                                                                                                in builtins.attrValues ( builtins.mapAttrs mapper secondary.mounts )
                                                                                                                                        )
                                                                                                                                    ]
                                                                                                                            ) ;
