                                                                                                                ...
                                                                                                                constructors =
                                                                                                                    builtins.concatLists
                                                                                                                        [
                                                                                                                            ...
                                                                                                                            ( builtins.map ( { index , initial , ... } : "makeWrapper ${ pkgs.writeShellScript "initial" "initial" } ${ _environment-variable "OUT" }/test/initial.${ index } --set PATH ${ pkgs.coreutils }/bin:${ initial }" ) secondary.mounts )
                                                                                                                            (
                                                                                                                                let
                                                                                                                                    mapper =
                                                                                                                                        { index , initial , ... } :
                                                                                                                                                                    ...
                                                                                                                                                                    initial =
                                                                                                                                                                        if builtins.typeOf initial == "string" then pkgs.writeShellScriptBin "initial" initial
                                                                                                                                                                            ...
                                                                                                                                                                            let
                                                                                                                                                                                ...
                                                                                                                                                                                in builtins.writeShellScriptBin "initial" ( builtins.concatStringsSep " &&\n\t" ( builtins.map mapper initial ) )
