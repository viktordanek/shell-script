                                                                                                                                                                            ...
                                                                                                                                                                            [
                                                                                                                                                                                ...
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                                                                        mapper =
                                                                                                                                                                                            name : { ... } :
                                                                                                                                                                                                "if /out/bin/${ builtins.hashString "sha512" name } > /out/initial/${ builtins.hashString "sha512" name }.standard-output 2> /out/initial/${ builtins.hashString "sha512" name }.standard-error ; then ${ _environment-variable "ECHO" } ${ _environment-variable "?" } > /out/initial/${ builtins.hashString "sha512" name }.status ; else ${ _environment-variable "ECHO" } ${ _environment-variable "?" } > /out/initial/${ builtins.hashString "sha512" name }.status ; fi" ;
                                                                                                                                                                                        in builtins.attrValues ( builtins.mapAttrs mapper secondary.mounts )
                                                                                                                                                                                )
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                                                                ...
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                                                                        mapper = name : { ... } : "${ _environment-variable "CP" } --recursive /work/${ builtins.hashString "sha512" name }/target /out/initial/${ builtins.hashString "sha512" name }" ;
                                                                                                                                                                                        in builtins.attrValues ( builtins.mapAttrs mapper secondary.mounts )
                                                                                                                                                                                )
                                                                                                                                                                                [
