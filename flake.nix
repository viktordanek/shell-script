                                                                                                                    ...
                                                                                                                    mapper =
                                                                                                                        value :
                                                                                                                            [
                                                                                                                                ...
                                                                                                                                ''${ _environment-variable "OUT" }/bin/observe.shelled.sh''
                                                                                                                                ''if [ -f ${ _environment-variable "WORK" }/SUCCESS ] ; then ${ _environment-variable "ECHO" } "  status: SUCCESS" ; elif [ -f ${ _environment-variable "WORK" }/FAILURE ] ; then ${ _environment-variable "ECHO" } "  status: FAILURE" && exit 64 ; else ${ _environment-variable "ECHO" } "  status: ERROR" && exit 64 ; fi''
