                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { host-path , vacuum-path , ... } : "${ _environment-variable "VACUUM" } ${ host-path } ${ vacuum-path } ${ name }" ) secondary.mounts ) )
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { observed-path , vacuum-path , ... } : "${ _environment-variable "CP" } --recursive ${ vacuum-path } ${ observed-path }" ) secondary.mounts ) )
                                                                                                                                        [
