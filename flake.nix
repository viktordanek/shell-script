                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        [
                                                                                                                                            "makeWrapper ${ pkgs.writeShellScript "observe" observe } ${ _environment-variable "OUT" }/bin/observe.wrapped.sh --set CAT ${ _environment-variable "CAT" } --set CUT ${ _environment-variable "CUT" } --set CP ${ _environment-variable "CP" } --set ECHO ${ _environment-variable "ECHO" } --set MKDIR ${ _environment-variable "MKDIR" } --set OUT ${ _environment-variable "OUT" } --set SHA512SUM ${ _environment-variable "SHA512SUM" } --set STAT ${ _environment-variable "STAT" }"
                                                                                                                                            (
                                                                                                                                                let
                                                                                                                                                    user-environment =
                                                                                                                                                        pkgs.buildFHSUserEnv
                                                                                                                            ...
                                                                                                                            builtins.concatLists
                                                                                                                                [
                                                                                                                                    ...
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        "${ _environment-variable "FIND" } /mount/mounts -mindepth 1 | while read FILE ; do UUID=$( ${ _environment-variable "ECHO" } ${ _environment-variable "FILE" } | ${ _environment-variable "SHA512SUM" } | ${ _environment-variable "CUT" } --bytes -128 ) && ${ _environment-variable "ECHO" } ${ _environment-variable "FILE" } > /mount/observed/${ _environment-variable "UUID" }.key && ${ _environment-variable "STAT" } --format %A ${ _environment-variable "FILE" } > /mount/observed/${ _environment-variable "UUID" }.stat && if [ -f ${ _environment-variable "FILE" } ] ; then ${ _environment-variable "CAT" } ${ _environment-variable "FILE" } > /mount/observed/${ _environment-variable "UUID" }.cat ; fi ; done"
                                                                                                                                    ]
                                                                                                                                ]
                                                                                                                        ) ;
                                                                                                                in
