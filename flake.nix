                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { host-path , vacuum-path , ... } : "if [ -f ${ host-path }  ] ; then ${ _environment-variable "VACUUM" } ${ host-path } ${ vacuum-path } ${ name } ; fi" ) secondary.mounts ) )
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { observed-path , vacuum-path , ... } : "if [ -f ${ vacuum-path } ] ; then ${ _environment-variable "CP" } --recursive ${ vacuum-path } ${ observed-path } ; fi" ) secondary.mounts ) )
                                                                                                                                        [
                                                                                                                                        ...
                                                                                                                                        (
                                                                                                                                            let
                                                                                                                                                mapper =
                                                                                                                                                    name : { expected , expected-path , ... } :
                                                                                                                                                        if builtins.typeOf expected == "null" then "${ _environment-variable "TRUE" }"
                                                                                                                                                        else "${ _environment-variable "CP" } --recursive ${ expected } ${ expected-path }" ;
                                                                                                                                                in builtins.mapAttrs mapper secondary.mounts
                                                                                                                                        )
                                                                                                                                        [
