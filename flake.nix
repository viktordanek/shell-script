                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        [
                                                                                                                                            "makeWrapper ${ self + "/observe.sh" } ${ _environment-variable "OUT" }/bin/observe.wrapped.sh --set BASENAME ${ _environment-variable "BASENAME" } --set CAT ${ _environment-variable "CAT" } --set ECHO ${ _environment-variable "ECHO" } --set FIND ${ _environment-variable "FIND" } --set MKDIR ${ _environment-variable "MKDIR" }"
                                                                                                                                            (
                                                                                                                                                let
                                                                                                                                                    user-environment =
                                                                                                                                                        pkgs.buildFHSUserEnv
