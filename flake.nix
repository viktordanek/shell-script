                                                                                                                                                                            ...
                                                                                                                                                                            [
                                                                                                                                                                                ...
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                                                                        mapper =
                                                                                                                                                                                            name : { ... } :
                                                                                                                                                                                                ''if [ $( ${ _environment-variable "CAT" } /work/${ builtins.hashString "sha512" name }/status ) != 0 ] ; then ${ _environment-variable "ECHO" } error status with ${ name } >&2 && exit 63 ; elif [ ! -z "$( ${ _environment-variable "CAT" } /work/${ builtins.hashString "sha512" name }/standard-error )" ] ; then ${ _environment-variable "ECHO" } error output with ${ name } >&2 && exit 62 ; elif [ ! -e /work/${ builtins.hashString "sha512" name }/target ] ; then ${ _environment-variable "ECHO" } missing target in ${ name } >&2 && exit 61 ; elif [ ! -e /work/${ builtins.hashString "sha512" name }/status ] ; then ${ _environment-variable "ECHO" } missing status in ${ name } >&2 && exit 60 ; elif [ ! -e /work/${ builtins.hashString "sha512" name }/standard-error ] ; then ${ _environment-variable "ECHO" } missing standard-error in ${ name } >&2 && exit 59 ; fi'' ;
                                                                                                                                                                                        in builtins.attrValues ( builtins.mapAttrs mapper secondary.mounts )
                                                                                                                                                                                )
                                                                                                                                                                                [
                                                                                                                                                                                ]
