                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { initial , ... } : "${ _environment-variable "MKDIR" } ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }" ) secondary.mounts ) )
                                                                                                                                        (
                                                                                                                                            let
                                                                                                                                                mapper =
                                                                                                                                                    name : { ... } :
                                                                                                                                                                            ...
                                                                                                                                                                            [
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                                                                        mapper =
                                                                                                                                                                                            name : { ... } :
                                                                                                                                                                                                "if /out/bin/${ builtins.hashString "sha512" name } > /work/${ builtins.hashString "sha512" name }/standard-output 2> /work/${ builtins.hashString "sha512" name }/standard-error ; then ${ _environment-variable "ECHO" } ${ _environment-variable "?" } > /work/${ builtins.hashString "sha512" name }/status ; else ${ _environment-variable "ECHO" } ${ _environment-variable "?" } > /work/${ builtins.hashString "sha512" name }/status ; fi" ;
                                                                                                                                                                                        in builtins.attrValues ( builtins.mapAttrs mapper secondary.mounts )
                                                                                                                                                                                )
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                                                                        mapper =
                                                                                                                                                                                            name : { ... } :
                                                                                                                                                                                                ''if [ $( ${ _environment-variable "CAT" } /work/${ builtins.hashString "sha512" name }/status ) != 0 ] ; then ${ _environment-variable "ECHO" } error status with ${ name } >&2 && exit 63 ; elif [ ! -z "$( ${ _environment-variable "CAT" } /work/${ builtins.hashString "sha512" name }/standard-error )" ] ; then ${ _environment-variable "ECHO" } error output with ${ name } >&2 && exit 62 ; elif [ ! -e /work/${ builtins.hashString "sha512" name }/target ] ; then ${ _environment-variable "ECHO" } missing target in ${ name } >&2 && exit 61 ; elif [ ! -e /work/${ builtins.hashString "sha512" name }/status ] ; then ${ _environment-variable "ECHO" } missing status in ${ name } >&2 && exit 60 ; elif [ ! -e /work/${ builtins.hashString "sha512" name }/standard-error ] ; then ${ _environment-variable "ECHO" } missing standard-error in ${ name } >&2 && exit 59 ; elif [ ! -e /work/${ builtins.hashString "sha512" name }/standard-output ] ; then ${ _environment-variable "ECHO" } missing standard-output in ${ name } >&2 && exit 58 ; elif [ $( ${ _environment-variable "FIND" } /work/${ builtins.hashString "sha512" name } -mindepth 1 -maxdepth 1 | ${ _environment-variable "WC" } --lines ) != 4 ] ; then ${ _environment-variable "ECHO" } wrong in ${ name } >&2 && exit 57 ; fi'' ;
                                                                                                                                                                                        in builtins.attrValues ( builtins.mapAttrs mapper secondary.mounts )
                                                                                                                                                                                )
                                                                                                                                                                                [
