                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { ... } : "makeWrapper ${ pkgs.writeShellScript "script" ( builtins.readFile ( self + "/initial.sh" ) ) } ${ _environment-variable "OUT" }/bin/initial.${ builtins.hashString "sha512" name }.guarded.sh --set CAT ${ _environment-variable "CAT" } --set ECHO ${ _environment-variable "ECHO" } --set FIND ${ _environment-variable "FIND" } --set INITIAL ${ _environment-variable "OUT" }/bin/initial.wrapped.sh --set WC ${ _environment-variable "WC" }" ) secondary.mounts ) )
                                                                                                                                        (
                                                                                                                                            let
                                                                                                                                                mapper =
                                                                                                                                                    name : { ... } :
                                                                                                                                                    ...
                                                                                                                                                    observe =
                                                                                                                                                        builtins.concatStringsSep
                                                                                                                                                            ...
                                                                                                                                                            (
                                                                                                                                                                builtins.concatLists
                                                                                                                                                                    [
                                                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { ... } : "${ _environment-variable "OUT" }/bin/initial.${ builtins.hashString "sha512" name }.guarded.sh" ) secondary.mounts ) )
                                                                                                                                                                    ]
                                                                                                                                                            ) ;
                                                                                                                                                        in "${ _environment-variable "LN" } --symbolic ${ pkgs.writeShellScript "observe" observe } ${ _environment-variable "OUT" }/bin/observe.sh"
                                                                                                                                            )
                                                                                                                                            "makeWrapper ${ _environment-variable "OUT" }/bin/observe.sh ${ _environment-variable "OUT" }/bin/observe.wrapped.sh --set BASENAME ${ _environment-variable "BASENAME" } --set CAT ${ _environment-variable "CAT" } --set ECHO ${ _environment-variable "ECHO" } --set FIND ${ _environment-variable "FIND" } --set LN ${ _environment-variable "LN" } --set MKDIR ${ _environment-variable "MKDIR" } --set OUT $out --set SORT ${ _environment-variable "SORT" }"
                                                                                                                                            (
                                                                                                                                                let
                                                                                                                                                    user-environment =
                                                                                                                                                        pkgs.buildFHSUserEnv
                                                                                                                ...
                                                                                                                in
                                                                                                                    ''
                                                                                                                        ${ pkgs.coreutils }/bin/mkdir $out &&
                                                                                                                            ...
                                                                                                                            makeWrapper $out/bin/constructors.sh $out/bin/constructors --set BASENAME ${ pkgs.coreutils }/bin/basename --set CAT ${ pkgs.coreutils }/bin/cat --set CHMOD ${ pkgs.coreutils }/bin/chmod --set CP ${ pkgs.coreutils }/bin/cp --set DIFF ${ pkgs.diffutils }/bin/diff --set ECHO ${ pkgs.coreutils }/bin/echo --set FIND ${ pkgs.findutils }/bin/find --set LN ${ pkgs.coreutils }/bin/ln --set MKDIR ${ pkgs.coreutils }/bin/mkdir --set MAKE_WRAPPER ${ pkgs.makeWrapper } --set OUT $out --set SORT ${ pkgs.coreutils }/bin/sort --set TOUCH ${ pkgs.coreutils }/bin/touch --set VACUUM ${ vacuum.shell-script } --set WC ${ pkgs.coreutils }/bin/wc &&
