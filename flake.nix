                                                                                                                                                                            ...
                                                                                                                                                                            [
                                                                                                                                                                                ...
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                                                                        mapper =
                                                                                                                                                                                            name : { ... } :
                                                                                                                                                                                                "if /out/bin/${ builtins.hashString "sha512" name } > /out/initial/${ builtins.hashString "sha512" name }.standard-output 2> /out/initial/${ builtins.hashString "sha512" name }.standard-error ; then ${ _environment-variable "ECHO" } ${ _environment-variable "?" } > /out/initital/${ builtins.hashString "sha512" name }.status ; else ${ _environment-variable "ECHO" } ${ _environment-variable "?" } > /out/initial/${ builtins.hashString "sha512" name }.status ; fi" ;
                                                                                                                                                                                        in builtins.attrValues ( builtins.mapAttrs mapper secondary.mounts )
                                                                                                                                                                                )
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                                                                        mapper =
                                                                                                                                                                                            name : { ... } :
                                                                                                                                                                                                ''if [ $( ${ _environment-variable "CAT" } /out/initial/${ builtins.hashString "sha512" name }.status ) != 0 ] ; then ${ _environment-variable "ECHO" } error status with ${ name } >> $out/ERROR ; elif [ ! -z "$( ${ _environment-variable "CAT" } /out/initial/${ builtins.hashString "sha512" name }.standard-error )" ] ; then ${ _environment-variable "ECHO" } error output with ${ name } >> /out/ERROR ; elif [ ! -e /work/${ builtins.hashString "sha512" name }/target ] ; then ${ _environment-variable "ECHO" } missing target in ${ name } >&2 && exit 61 ; elif [ $( ${ _environment-variable "FIND" } /work/${ builtins.hashString "sha512" name } -mindepth 1 -maxdepth 1 | ${ _environment-variable "WC" } --lines ) != 1 ] ; then ${ _environment-variable "ECHO" } wrong in ${ name } >&2 && exit 57 ; fi'' ;
                                                                                                                                                                                        in builtins.attrValues ( builtins.mapAttrs mapper secondary.mounts )
                                                                                                                                                                                )
                                                                                                                                                                                (
                                                                                                                                                                                    let
                                                                                                                                                                                        mapper = name : { ... } : "${ _environment-variable "CP" } --recursive /work/${ builtins.hashString "sha512" name }/target /out/initial/${ builtins.hashString "sha512" name }/target" ;
                                                                                                                                                                                        in builtins.attrValues ( builtins.mapAttrs mapper secondary.mounts )
                                                                                                                                                                                )
                                                                                                                                                                                [
