                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { initial-path , ... } : "if [ ! -e ${ initial-path }/target ] ; then ${ _environment-variable "ECHO" } target was not created. >&2 && exit 63 ; fi" ) secondary.mounts ) )
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { initial-path , ... } : "if [ $( ${ _environment-variable "FIND" } ${ initial-path } -mindepth 1 -maxdepth 1 | ${ _environment-variable "WC" } --lines ) != 1 ] ; then ${ _environment-variable "ECHO" } extra files were created. >&2 && exit 63 ; fi" ) secondary.mounts ) )
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { observed-path , vacuum-path , ... } : "if [ -e ${ vacuum-path } ] ; then ${ _environment-variable "CP" } --recursive ${ vacuum-path } ${ observed-path } ; fi" ) secondary.mounts ) )
                                                                                                                                        [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { expected , expected-path , ... } : "${ if builtins.typeOf expected == "null" then "#" else "" }${ _environment-variable "CP" } --recursive ${ expected } ${ expected-path }" ) secondary.mounts ) )
                                                                                                                                        [
                                                                                                                                    ...
                                                                                                                                    name : { expected , initial } :
                                                                                                                                        {
                                                                                                                                            ...
                                                                                                                                            expected =
                                                                                                                                                if builtins.typeOf expected == "null" then expected
                                                                                                                                                else if builtins.typeOf expected == "string" then
                                                                                                                                            ...
                                                                                                                                            initial =
                                                                                                                                                if builtins.typeOf initial == "bool" then
                                                                                                                                                    if initial then "${ _environment-variable "MKDIR" } /mount/target"
                                                                                                                                                    else "${ _environment-variable "TOUCH" } /mount/target"
                                                                                                                                                else if builtins.typeOf initial == "list" then builtins.concatStringsSep " &&\n\t" ( builtins.map ( value : if builtins.typeOf value == "string" then value else builtins.throw "initial is not string but ${ builtins.typeOf value }." ) initial )
                                                                                                                                                else if builtins.typeOf initial == "string" then initial
                                                                                                                                                else builtins.throw "initial is not bool, list, string but ${ builtins.typeOf initial }." ;
