                                                                                                                        ...
                                                                                                                        (
                                                                                                                            builtins.concatLists
                                                                                                                                [
                                                                                                                                    ...
                                                                                                                                    [
                                                                                                                                        "${ _environment-variable "FIND" } /mount/mounts -mindepth 1 | while read FILE ; do UUID=$( ${ _environment-variable "ECHO" } ${ _environment-variable "FILE" } | ${ _environment-variable "SHA512SUM" } | ${ _environment-variable "CUT" } --bytes -128 ) && ${ _environment-variable "ECHO" } ${ _environment-variable "FILE" } > /mount/observed/mounts/${ _environment-variable "UUID" }.key && ${ _environment-variable "STAT" } --format %A ${ _environment-variable "FILE" } > /mount/observed/mounts/${ _environment-variable "UUID" }.stat && if [ -f ${ _environment-variable "FILE" } ] ; then ${ _environment-variable "CAT" } ${ _environment-variable "FILE" } > /mount/observed/mounts/${ _environment-variable "UUID" }.cat ; fi ; done"
