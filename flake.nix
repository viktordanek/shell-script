                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        [
                                                                                                                                            "makeWrapper ${ pkgs.writeShellScript "observe" observe } ${ _environment-variable "OUT" }/bin/observe --set MKDIR ${ _environment-variable "MKDIR" } --set OUT ${ _environment-variable "OUT" }"
                                                                                                                                        ]
                                                                                                                                        (
                                                                                                                                            let
                                                                                                                                                mapper =
