                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { initial-path , ... } : "${ _environment-variable "MKDIR" } ${ _environment-variable "WORK" }/mounts/${ builtins.hashString "sha512" name }" ) secondary.mounts ) )
                                                                                                                                        [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { initial-path , ... } : "if [ ! -e ${ _environment-variable "WORK" }/mounts/${ builtins.hashString "sha512" name }/target ] ; then ${ _environment-variable "ECHO" } ${ primary.uninitialized-target-error-message } >&2 && exit ${ primary.uninitialized-target-error-code } ; fi" ) secondary.mounts ) )
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { initial-path , ... } : "if [ $( ${ _environment-variable "FIND" } ${ _environment-variable "WORK" }/mounts/${ builtins.hashString "sha512" name } -mindepth 1 -maxdepth 1 | ${ _environment-variable "WC" } --lines ) != 1 ] ; then ${ _environment-variable "FIND" } ${ _environment-variable "WORK" }/mounts/${ builtins.hashString "sha512" name } -mindepth 1 -maxdepth 1 && ${ _environment-variable "ECHO" } ${ primary.over-initialized-target-error-message } >&2 && exit ${ primary.over-initialized-target-error-code } ; fi" ) secondary.mounts ) )
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { initial-path , host-path , ... } : "${ _environment-variable "CP" } --recursive ${ _environment-variable "WORK" }/mounts/${ builtins.hashString "sha512" name }/target ${ host-path }" ) secondary.mounts ) )
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { initial-path , test-path , ... } : "${ _environment-variable "CP" } --recursive ${ _environment-variable "WORK" }/mounts/${ builtins.hashString "sha512" name }/target ${ test-path }" ) secondary.mounts ) )
                                                                                                                                        [
                                                                                                                                            (
                                                                                                                                                let
                                                                                                                                                    user-environment =
