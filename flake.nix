                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { ... } : "makeWrapper ${ pkgs.writeShellScript "script" ( builtins.readFile ( self + "/initial.sh" ) ) } ${ _environment-variable "OUT" }/bin/initial.${ builtins.hashString "sha512" name }.guarded.sh --set ECHO ${ _environment-variable "ECHO" } --set INITIAL ${ _environment-variable "OUT" }/bin/initial.wrapped.sh" ) secondary.mounts ) )
                                                                                                                                        (
                                                                                                                                            let
                                                                                                                                                mapper =
                                                                                                                                                    name : { ... } :
