                                                                                                                                                                                ...
                                                                                                                                                                                builtins.concatLists
                                                                                                                                                                                    [
                                                                                                                                                                                        ...
                                                                                                                                                                                        [
                                                                                                                                                                                            ...
                                                                                                                                                                                            ''if [ ! -z "$( ${ _environment-variable "CAT" }${ _environment-variable "WORK" }/diff )" ] ; then exit 64 ; fi''
                                                                                                                                                                                        ]
                                                                                                                                                                                    ]
                                                                                                                                                                            ) ;
                                                                                                                    ...
                                                                                                                    mapper =
                                                                                                                        value :
                                                                                                                            [
                                                                                                                                ...
                                                                                                                                ''${ _environment-variable "OUT" }/bin/observe.shelled.sh''
                                                                                                                                ''if [ -f ${ _environment-variable "WORK" }/SUCCESS ] ; then ${ _environment-variable "ECHO" } "  status: SUCCESS" ; elif [ -f ${ _environment-variable "WORK" }/FAILURE ] ; then ${ _environment-variable "ECHO" } "  status: FAILURE" ; else ${ _environment-variable "ECHO" } "  status: ERROR" ; fi''
                                                                                                                                ''if [ -f ${ _environment-variable "WORK" }/SUCCESS ] ; then ${ _environment-variable "RM" } --recursive --force ${ _environment-variable "WORK" } ; elif [ -f ${ _environment-variable "WORK" }/FAILURE ] ; then exit 64 ; else exit 64 ; fi''
                                                                                                                            ] ;
