                                                                                                                ...
                                                                                                                in
                                                                                                                    ''
                                                                                                                        ${ pkgs.coreutils }/bin/mkdir $out &&
                                                                                                                            ...
                                                                                                                            makeWrapper $out/bin/build.sh $out/bin/build --set ECHO ${ pkgs.coreutils }/bin/echo --set MKDIR ${ pkgs.coreutils }/bin/mkdir --set MAKE_WRAPPER ${ pkgs.makeWrapper } --set MV ${ pkgs.coreutils }/bin/mv --set OUT $out &&
                                                                                                                            $out/bin/build
                                                                                                                    '' ;
                                                                                                        installPhase =
                                                                                                            ''
