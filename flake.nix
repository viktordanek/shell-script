                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { ... } : "makeWrapper ${ pkgs.writeShellScript "initial" ( builtins.readFile ( self + "/initial.sh" ) ) } ${ _environment-variable "OUT" }/bin/initial.${ builtins.hashString "sha512" name }.guarded.sh --set INITIAL ${ _environment-variable "OUT" }/bin/initial.${ builtins.hashString "sha512" name }.guarded.sh --set CAT ${ _environment-variable "CAT" } --set ECHO ${ _environment-variable "ECHO" } --set FIND ${ _environment-variable "FIND" } --set INITIAL ${ _environment-variable "OUT" }/bin/initial.${ builtins.hashString "sha512" name }.wrapped.sh --set LN ${ _environment-variable "LN" } --set MKDIR ${ _environment-variable "MKDIR" } --set WC ${ _environment-variable "WC" }" ) secondary.mounts ) )
                                                                                                                                        (
                                                                                                                                            let
                                                                                                                                                mapper =
                                                                                                                                                    name : { ... } :
