                                                                                                                        ...
                                                                                                                        " &&\n\t"
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        [
                                                                                                                                            "cleanup ( ) { if [ ${ _environment-variable "?" } != 0 ] ; then ${ _environment-variable "TOUCH" } ${ _environment-variable "OUT" }/ERROR ; fi }"
                                                                                                                                            "trap cleanup EXIT"
                                                                                                                                        ]
                                                                                                                                        [
                                                                                                                                            ...
                                                                                                                                            (
                                                                                                                                                let
                                                                                                                                                    user-environment =
                                                                                                                                                        pkgs.buildFHSUserEnv
                                                                                                                                                            {
                                                                                                                                                                extraBwrapArgs = [ "--bind ${ _environment-variable "OUT" } /out" "--bind ${ _environment-variable "WORK" } /work" ] ;
                                                                                                                                                                name = "observe" ;
                                                                                                                                                                runScript =
                                                                                                                                                                        ...
                                                                                                                                                                        (
                                                                                                                                                                            let
                                                                                                                                                                                initial-mapper =
                                                                                                                                                                                    name : { initial , ... } :
                                                                                                                                                                                        [
                                                                                                                                                                                            "${ _environment-variable "MKDIR" } /work/${ builtins.hashString "sha512" name }"
                                                                                                                                                                                            (
                                                                                                                                                                                                let
                                                                                                                                                                                                    user-environment =
                                                                                                                                                                                                        pkgs.buildFHSUserEnv
                                                                                                                                                                                                            {
                                                                                                                                                                                                                extraBwrapArgs = [ "--bind ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name } /mount" ] ;
                                                                                                                                                                                                                name = "initial" ;
                                                                                                                                                                                                                runScript = initial ;
                                                                                                                                                                                                                profile =
                                                                                                                                                                                                                    ''
                                                                                                                                                                                                                        export ECHO=${ _environment-variable "ECHO" } &&
                                                                                                                                                                                                                            export PATH=${ pkgs.coreutils }/bin"
                                                                                                                                                                                                                    '' ;
                                                                                                                                                                                                            } ;
                                                                                                                                                                                                    in "if ${ user-environment }/bin/initial > ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" }.standard-output 2> ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" }/.standard-error then ${ _environment-variable "ECHO" } ${ _environment-variable "?" } > ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }/.status ; else ${ _environment-variable "ECHO" } ${ _environment-variable "?" } > ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }.status ; fi"
                                                                                                                                                                                            )
                                                                                                                                                                                            ''if [ $( ${ _environment-variable "CAT" } ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }.status ) != 0 ] ; then ${ _environment-variable "ECHO" } non-zero exit for ${ name } >&2 && exit 63 ; elif [ ! -z "$( ${ _environment-variable "CAT" } ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }.standard-error )" ] then ${ _environment-variable "ECHO" } non-empty error for ${ name } >&2 && exit 62 ; elif [ ! -e ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }/target ] ; then ${ _environment-variable "ECHO" } no target for ${ name } >&2 && exit 61 ; elif $( ${ _environment-variable "FIND" } ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name } -mindepth 1 -maxdepth 1 ) != 1 ; then ${ _environment-variable "ECHO" } target error for ${ name } >&2 && exit 60 ; fi''
                                                                                                                                                                                            "${ _environment-variable "CP" } --recursive ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }/target ${ _environment-variable "OUT" }/initial/${ builtins.hashString "sha512" name }"
                                                                                                                                                                                            "${ _environment-variable "CP" } ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }.standard-error ${ _environment-variable "OUT" }/initial/${ builtins.hashString "sha512" name }.standard-error"
                                                                                                                                                                                            "${ _environment-variable "CP" } ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }/.standard-output ${ _environment-variable "OUT" }/initial/${ builtins.hashString "sha512" name }.standard-output"
                                                                                                                                                                                            "${ _environment-variable "CP" } ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }/.status ${ _environment-variable "OUT" }/initial/${ builtins.hashString "sha512" name }.status"
                                                                                                                                                                                        ] ;
                                                                                                                                                                                post-mapper =
                                                                                                                                                                                    name : { ... } :
                                                                                                                                                                                        "INPUT=${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }/target OUTPUT=${ builtins.hashString "sha512" name } ${ _environment-variable "VACUUM" }" ;
                                                                                                                                                                                user-environment =
                                                                                                                                                                                    pkgs.buildFHSUserEnv
                                                                                                                                                                                        {
                                                                                                                                                                                            extraBwrapArgs = builtins.attrValues ( builtins.mapAttrs ( name : { is-read-only , ... } : "${ if is-read-only then "--ro-bind" else "--bind" } ${ _environment-variable "WORK" }/${ builtins.hashString "sha512" name }/target ${ name }"  ) secondary.mounts ) ;
                                                                                                                                                                                            name = "observe" ;
                                                                                                                                                                                            runscript = pkgs.writeShellScript "test" secondary.test ;
                                                                                                                                                                                        } ;
                                                                                                                                                                                in
                                                                                                                                                                                    ''
                                                                                                                                                                                        ${ builtins.concatStringsSep " &&\n\t" ( builtins.attrValues ( builtins.mapAttrs initial-mapper secondary.mounts ) ) } &&
                                                                                                                                                                                            if ${ user-environment }/bin/observe > ${ _environment-variable "WORK" }/observe.standard-output 2> ${ _environment-variable "WORK" }/observe.standard-error
                                                                                                                                                                                            then
                                                                                                                                                                                                ${ _environment-variable "ECHO" } ${ _environment-variable "?" } > ${ _environment-variable "WORK" }/observe.status
                                                                                                                                                                                                elif ${ _environment-variable "ECHO" } ${ _environment-variable "?" } > ${ _environment-variable "WORK" }/observe.status
                                                                                                                                                                                            fi &&
                                                                                                                                                                                            if [ $( ${ _environment-variable "CAT" } ${ _environment-variable "WORK" }/observe.status ) != 0 ]
                                                                                                                                                                                            then
                                                                                                                                                                                                ${ _environment-variable "ECHO" } non-zero status >&2 &&
                                                                                                                                                                                                    exit 59
                                                                                                                                                                                            elif [ ! -z "$( ${ _environment-variable "CAT" } ${ _environment-variable "WORK" }/observe.standard-error )" ]
                                                                                                                                                                                            then
                                                                                                                                                                                                ${ _environment-variable "ECHO" } non-empty error >&2 &&
                                                                                                                                                                                                    exit 58
                                                                                                                                                                                            fi &&
                                                                                                                                                                                            ${ _environment-variable "CAT" } ${ _environment-variable "WORK" }/observe.standard-output > ${ _environment-variable "OUT" }/observed/standard-output &&
                                                                                                                                                                                            ${ _environment-variable "CAT" } ${ _environment-variable "WORK" }/observe.standard-error > ${ _environment-variable "OUT" }/observed/standard-error &&
                                                                                                                                                                                            ${ _environment-variable "CAT" } ${ _environment-variable "WORK" }/observe.status > ${ _environment-variable "OUT" }/observed.status &&
                                                                                                                                                                                            ${ builtins.concatStringsSep " &&\n\t" ( builtins.attrValues ( builtins.mapAttrs post-mapper secondary.mounts ) ) }
                                                                                                                                                                                    ''
                                                                                                                                                                        ) ;
                                                                                                                                                                profile =
                                                                                                                                                                    ''
                                                                                                                                                                        export CAT=${ _environment-variable "CAT" } &&
                                                                                                                                                                            export CP=${ _environment-variable "CP" } &&
                                                                                                                                                                            export ECHO=${ _environment-variable "ECHO" } &&
                                                                                                                                                                            export FIND=${ _environment-variable "FIND" } &&
                                                                                                                                                                            export MKDIR=${ _environment-variable "MKDIR" } &&
                                                                                                                                                                            export VACUUM=${ vacuum.shell-script }
                                                                                                                                                                    '' ;
                                                                                                                                                            } ;
                                                                                                                                        ...
                                                                                                                                        (
                                                                                                                                            if secondary.delayed then
                                                                                                                                                ...
                                                                                                                                                [
                                                                                                                                                    "${ _environment-variable "DIFF" } --recursive ${ _environment-variable "OUT" }/expected ${ _environment-variable "OUT" }/observed > ${ _environment-variable "OUT" }/diff"
                                                                                                                                                    ''if [ -z "$( ${ _environment-variable "CAT" } ${ _environment-variable "OUT" }/diff )" ] ; then ${ _environment-variable "TOUCH" } ${ _environment-variable "OUT" }/SUCCESS ; else ${ _environment-variable "TOUCH" } ${ _environment-variable "OUT" }/FAILURE ; fi''
                                                                                                                                                ]
                                                                                                                                        )
                                                                                                                                    ]
                                                                                                                            ) ;
