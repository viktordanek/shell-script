                                                                                                                            ...
                                                                                                                            (
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( builtins.attrValues ( builtins.mapAttrs ( name : { initial , ... } : "makeWrapper ${ pkgs.writeShellScript "initial" ( builtins.readFile ( self + "/initial.sh" ) ) } ${ _environment-variable "OUT" }/bin/${ builtins.hashString "sha512" name }.guarded.sh --set ECHO ${ _environment-variable "ECHO" } --set FIND ${ pkgs.coreutils }/bin/find --set INITIAL ${ _environment-variable "OUT" }/bin/${ builtins.hashString "sha512" name }.wrapped.sh --set WC ${ pkgs.coreutils }/bin/wc" ) secondary.mounts ) )
                                                                                                                                        (
                                                                                                                                            let
                                                                                                                                                mapper =
                                                                                                                                                    name : { ... } :
