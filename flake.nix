                                                                    ...
                                                                    in
                                                                        ''
                                                                            ${ pkgs.coreutils }/bin/mkdir $out &&
                                                                                ...
                                                                                ${ pkgs.coreutils }/bin/echo ALL=${ _environment-variable "ALL" } SUCCESS=${ _environment-variable "SUCCESS" } FAILURE=${ _environment-variable "FAILURE" } >> $out/DEBUG &&
                                                                                ${ pkgs.coreutils }/bin/echo SUCCESS = ${ _environment-variable "SUCCESS" } + FAILURE = ${ _environment-variable "FAILURE" } =?  $(( ${ _environment-variable "SUCCESS" } + ${ _environment-variable "FAILURE" } )) >> $out/DEBUG
