                                                                                                                                ...
                                                                                                                                builtins.concatLists
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        [
                                                                                                                                            ...
                                                                                                                                            "makeWrapper ${ _environment-variable "OUT" }/bin/vacuum.sh ${ _environment-variable "OUT" }/bin/vacuum.wrapped.sh --set CHMOD ${ _environment-variable "CHMOD" } --set CUT ${ _environment-variable "CUT" } --set ECHO ${ _environment-variable "ECHO" } --set FIND ${ _environment-variable "FIND" } --set SHA512 ${ _environment-variable "SHA512" } --set STAT ${ _environment-variable "STAT" } --set WC ${ _environment-variable "WC" }"
                                                                                                                                        ]
                                                                                                                                        (
                                                                                                                                            let
                                                                                                                                                mapper =
